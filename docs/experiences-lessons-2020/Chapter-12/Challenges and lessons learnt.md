...
- In Namibia there was a lesson learned on being clear about the different phases of the census - public were concerned that their data had already been collected, not realizing there was listing, then enumeration, then also post-enumeration survey (PES) stages. See more lessons in the [pre-enumeration household listing](docs/experiences-lessons-2020/Chapter-10/Introduction.md). There was a useful lesson in Namibia where some regional statisticians informed the central meeting that they were in close contact with neighborhood watch schemes and took more time to talk to farmers in their usual data collection. This point was suggested to the other regions.

Some of the challenges faced in dissemination of census products include:

- Technical obstacles to disseminate census products e.g., websites not optimally functional, no/outdated microdata dissemination platforms, funding constraints, staff shortages, skills constraints (IT, data and metadata management, data anonymisation skills, training in data platform administration); technical skills: microdata archiving skills, knowledge of data anonymisation techniques.
