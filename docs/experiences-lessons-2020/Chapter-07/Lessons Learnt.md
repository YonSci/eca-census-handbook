...
There is a need to have a high-speed bandwidth considering that multiple tablets (as many as 200) may be connecting to the network simultaneously with each one downloading files of considerable size. Experience from Kenya suggests using devices that support a bandwidth of 10Gbps to achieve an overall speed of 10Gbps bandwidth throughout the network.
