...
- In Zambia, the census dashboard was not tested due to delay in procuring the server at the time of the final pretest. More human resources to ensure streamlined roles so that data quality staff could focus on working on the census dashboard to provide timely feedback.
