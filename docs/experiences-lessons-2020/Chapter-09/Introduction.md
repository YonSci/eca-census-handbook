...
The UN handbook on census management emphasises integrating risk planning into every phase of the census cycle.
...
- In conducting a risk assessment, evaluate the likelihood and impact of each identified potential risk using tools like risk matrices and scenario planning to prioritise them. 
