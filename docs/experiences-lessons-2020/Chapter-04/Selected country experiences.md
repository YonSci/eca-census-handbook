...
In Sierra Leone, the use of Geographical Information Systems (GIS) tools and cloud-based systems enabled efficient data collection and transmission. Local mobile providers played a key role in ensuring connectivity, and the integration of mapping tools improved the accuracy of enumeration.
...
[Visit the case studies section](/docs/case-studies/Data%20Capture,%20Transmission%20and%20Management)
