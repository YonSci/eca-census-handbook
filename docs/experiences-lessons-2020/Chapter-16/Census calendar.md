...
A check list of what is required to populate a census calendar has been developed based on the UNFPA Step-By-Step reference guide (Gantt Chart) in combination with a typical country workplan used during the 2020 round of PHC.
