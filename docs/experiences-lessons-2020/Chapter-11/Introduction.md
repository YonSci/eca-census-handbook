...
In the non-digital era, collaboration happened in distinct phases (e.g., a partnership for printing, then a partnership for logistics). In the digital era, collaboration is continuous and in real-time. The NSO, the telecom, and the Information and Technology (IT) helpdesk must be in constant communication during the entire enumeration period.
