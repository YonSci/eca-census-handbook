...
Cartographic mapping is a major activity conducted during the pre-enumeration phase to create Enumeration Areas (EA) maps. Such maps are used for resource and personnel planning for census and work allocation during census enumeration as well as the frame for dissemination and geospatial referenced census data. Therefore, the quality of maps used in the census has a major influence on the quality and reliability of census data collected.

The mapping process involves the following activities: peculiar cultural and socioeconomic review, establishment of census geography, proposed methodology development, mobilisation of resources, development of tools, acquisition of equipment, publicity, piloting, recruitment, training, data collection, map production and EA map verification. 
