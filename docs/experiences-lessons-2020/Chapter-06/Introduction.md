...
An automated e-recruitment system may be used for recruitment of enumerators and other temporary staff, for example enabling candidates to apply, carry out initial sifting and complete tests online (see [**Botswana**](/docs/case-studies/6.%20Recruitment%20and%20Training%20of%20Field%20Personnel) for an example of carrying out online recruitment tests). Essential information such as identification numbers and banking details can also be collected via the e-recruitment system.
...
During recruitment, consider the place of residence and language(s) spoken by the applicants. Preferably, enumerators should be residents from the EA in which they will work. This makes logistics and administration easier and generally leads to good reception of enumerators during the field work. [(UN P&R, Rev 4, para. 2.211–2.221, para. 3.26)](https://unstats.un.org/unsd/publication/SeriesM/Series_M67Rev4en.pdf#page=130). The capability of the field personnel to use the devices and technology needs to be evaluated prior to deployment. What is your contingency strategy if you cannot recruit enough computer literate enumerators in some areas?
...
Training may be carried out in-person or online or in a hybrid manner that makes use of both in-person and online sessions. [(UN P&R, Rev 4, para. 2.215.)](https://unstats.un.org/unsd/publication/SeriesM/Series_M67Rev4en.pdf#page=131)
