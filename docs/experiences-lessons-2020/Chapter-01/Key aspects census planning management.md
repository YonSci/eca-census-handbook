...
*	A digital census budget plan should be in line with the Nation’s public finance management framework with consistent regulations as well as those regarding procurement and ownership of some digital tools like servers etc. 
...
The leadership of the census organisation should be guided to undertake their respective activities as outlined in the [UN P&R, Rev 4, para. 2.171 and 2.172](https://unstats.un.org/unsd/publication/SeriesM/Series_M67Rev4en.pdf#page=120).
