...
*   The prevailing financial constraint directly impacted census proposal development as planners often had to develop multiple budget scenarios based on different levels of potential government and donor funding, adding complexity to the proposal. Engaged in extensive and often lengthy advocacy. Extensive and lengthy advocacy meetings with potential donors were required.
*   Given that a digital census requires multiple testing of the technological requirements, some countries did not factor these tests into their budgets and plans early enough. They only realised the need for additional tests after or before implementing the pilot census. This introduced budgetary constraints due to unplanned costs.
*   In Tanzania, the decision of combining three national undertakings (PHC, Building Census and National Physical addressing) reduced the government budget of conducting each exercise separately.
...
*   Some key stakeholders failed to attend the meetings and only appeared when it was too late and long after implementation had started. This challenged the committee’s ability to track and follow-up on the deliberations. 
...
*   Conflict of interest among committee members due to their varied self- interests especially at the sub national level, which negatively impacted on census activities like recruitment and procurement. Kenya faced this at the sub national level.
