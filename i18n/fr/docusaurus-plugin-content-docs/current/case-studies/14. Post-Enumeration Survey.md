...
2. La fonction de différence d'âge qui permet une tolérance différente en fonction de l'âge. 
3. Alphanames est une variable dérivée qui classe tous les caractères des noms par ordre alphabétique.
4. RLSoundex est la fonction Soundex appliquée au nom, tous les R étant remplacés par des L (cette adaptation a été utilisée au Rwanda car R et L se prononcent de la même manière en kinyarwanda). 
