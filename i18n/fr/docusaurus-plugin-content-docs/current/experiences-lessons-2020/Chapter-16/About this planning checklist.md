...
- **Plans incomplets :** Certains pays n'ont pas intégré suffisamment tôt, dans leur budget et leurs plans, certaines activités liées à l'utilisation de la technologie dans la collecte de données, telles que la réalisation de multiples essais préliminaires des applications avant la phase pilote, ou encore la mise à l'essai de l'application cartographique, entre autres. Ils n'ont pris conscience de la nécessité d'essais supplémentaires qu'après ou avant la mise en œuvre du recensement pilote.

- **Estimation des délais :** certains pays ont sous-estimé le temps alloué à la réalisation des activités, ce qui a entraîné des retards et l'interruption de la phase suivante.
